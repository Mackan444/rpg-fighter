...
class Character:
    ...
    def generate_weapon(self):
        ...
        elif random_weapon >= 40 and random_weapon < 60: self.weapon = Weapon("Small kinfe", 1)
        elif random_weapon >= 60 and random_weapon < 80: self.weapon = Weapon("Spear", 2)
        elif random_weapon >= 80 and random_weapon < 90: self.weapon = Weapon("Halberd", 2)
        elif random_weapon >= 90 and random_weapon < 95: self.weapon = Weapon("Morning star", 10)
        elif random_weapon == 96: self.weapon = Weapon("Atiesh", 50)
        elif random_weapon == 97: self.weapon = Weapon("Excalibur", 15)
        elif random_weapon == 98: self.weapon = Weapon("Slagserie", 10)
        elif random_weapon == 99: self.weapon = Weapon("Sword of Khaine", 30)
        elif random_weapon == 96: self.weapon = Weapon("Frostmourne", 20)
